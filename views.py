...
def scrape(request):
    ...
    div1_1 = soup2.find('div', class_='quote-header-section Cf Pos(r) Mb(5px) Maw($maxModuleWidth) Miw($minGridWidth) smartphone_Miw(ini) Miw(ini)!--tab768 Miw(ini)!--tab1024 Mstart(a) Mend(a) Px(20px) smartphone_Pb(0px) smartphone_Mb(0px)')
    div2_1 = div1_1.find('div', class_='My(6px) Pos(r) smartphone_Mt(6px)').text
    ...
    return render(request, "userhome.html", {'div1':div1, 'div2_1':div2_1,'graph': graph})
